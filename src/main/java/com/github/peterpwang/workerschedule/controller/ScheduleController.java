...
public class ScheduleController {
	...
	public ResponseEntity<PagedResources<ScheduleResource>> findSchedule(Pageable pageable, PagedResourcesAssembler assembler) {
...
class ScheduleResourceAssembler extends ResourceAssemblerSupport<Schedule, ScheduleResource> {
  ...
  public ScheduleResource toResource(Schedule entity) {
	  ...
	  er.removeLinks();
	  er.add(ControllerLinkBuilder.linkTo(ScheduleController.class).slash("/schedules").slash(entity.getId()).withRel("self"));
	  er.add(ControllerLinkBuilder.linkTo(ScheduleController.class).slash("/schedules").slash(entity.getId()).withRel("schedule"));
